...
_STOP_WORDS = {
    "office", "no", "flat", "floor", "building", "bldg", "road", "rd", "street", "opp", "opposite",
    "near", "next", "behind", "chs", "ltd", "pvt", "society", "nagar", "wing", "plot", "unit",
    "shop", "gala", "tower", "complex", "sector", "estate", "marg", "avenue", "line", "village",
    "house", "chawl", "industrial", "area", "lane", "housing", "residential", "colony",
    "west", "east", "north", "south", "hill", "height", "heights", "park", "chowk", "chauk",
    "path", "gate", "square", "circle", "bridge", "peth", "gaon", "basti", "midc",
    "school", "cinema", "hotel", "market", "bazaar", "temple", "church", "hall", "mall",
    "bhavan", "sadan", "krupa", "guest", "college", "station", "post", "council", "club",
    "india", "maharashtra", "mumbai", "pune", "thane", "nagpur", "nashik", "jalna", "sangli",
    "aurangabad", "palghar", "kavesar",
}
